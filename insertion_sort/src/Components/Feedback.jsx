...
const Feedback=()=>{
    return (
        <div>
            <h1 className="text-xl sm:text-3xl font-semibold  mb-0 mt-4 text-center text-slate-900 ">Virtual lab on Sorting Algorithms</h1>
        <div className='sm:flex justify-around pb-2'>
            <div className='sm:m-5 sm:p-5 lg:mb-0 p-2 sm:mt-0 m-0'>
                ...
                <p className="sm:text-xl text-base sm:leading-relaxed sm:mt-5 text-stone-800">
        ...
        <button className="sm:ml-10 ml-3 bg-white text-gray-800 hover:bg-slate-800 hover:text-white font-semibold py-2 px-4 border border-gray-400 rounded shadow">
            <Link to='/Feedback/FeedbackForm'>Feedback Form</Link>
        </button>
        <p className="text-lg sm:text-xl sm:ml-10 ml-3  sm:leading-relaxed sm:mt-8 text-stone-800 pt-2">
        Thank you for taking the time to read this.
        </p>
        <h3 className="text-lg sm:text-xl font-bold ml-10  mt-2 text-stone-900 mb-7">Virtual Labs' Team</h3>
        </div>
    );
}
